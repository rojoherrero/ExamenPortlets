...
/**
 * Portlet implementation class PortletReceptorC
 */
public class PortletReceptorC extends GenericPortlet {
    ...
    private static Log _log = LogFactoryUtil.getLog(PortletReceptorC.class);
